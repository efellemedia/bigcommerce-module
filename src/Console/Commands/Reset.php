...
class Reset extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bigcommerce:reset';
     ...
     * @var string
     */
    protected $description = 'Remove BigCommerce tables and records from FusionCMS.';
    ...
    {
        $jobs = [
            'Rolling back...' => new \Modules\Bigcommerce\Jobs\ResetDatabaseTables
        ];
