...
class CategoryRequest implements ShouldQueue
{
     ...
     * @var string
     */
    private $endpoint = "v3/catalog/categories";
     ...
     * @return void
     */
    public function __construct($id = null, array $query = [])
    {
        $this->id        = $id;
    ...
    public function handle()
    {
        ...
        if (! is_null($pagination)) {
            if ($pagination->hasMorePages()) {
                ...
                dispatch(new CategoryRequest($this->id, $newQuery));
            }
        }
    }
    ...
    {
        return Category::updateOrCreate([ 'id' => $item->id ],
            [
