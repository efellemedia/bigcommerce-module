...
class ProductVideoRequest implements ShouldQueue
{
     ...
     * @var string
     */
    private $endpoint = "v3/catalog/products/{product_id}/videos";
    ...
    public function handle()
    {
        ...
        if (! is_null($pagination)) {
            if ($pagination->hasMorePages()) {
                ...
                dispatch(new ProductVideoRequest($this->productId, $newQuery));
            }
        }
    }
    ...
    {
        ProductVideo::updateOrCreate([ 'id' => $item->id ],
            [
